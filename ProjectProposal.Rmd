...
author:
  - name: Lim Jin Ru, Mayurapriyann Arulmozhi Baskaran, Yeo Ding Run Darius 
    affiliation: Master of IT in Business programme, Singapore Management University
output:
...
# 2. Dataset Overview
The group is working on the **[VAST Challenge 2021 Mini-Challenge 1 Dataset](https://www.vast-challenge.github.io/2021/MC1.html)**.
...
**[visNetwork](https://www.cran.r-project.org/web/packages/visNetwork/index.html)** | visNetwork package allows the building of network visualizations to visualize complex relationships between different elements.
