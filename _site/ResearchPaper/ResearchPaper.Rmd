...
# Design Framework
With inspiration from the paper, ‘DIVAD: A Dynamic and Interactive Visual Analytical Dashboard for Exploring and Analyzing Transport Data’ (Kam, 2012) of its applicational use of Schniederman’s Mantra (Schneiderman 1996), an influential organizing principle for the creation of visualization systems, we utilized the same principle for our design:
