---
title: "ISSS608 G1 Visual Analytics & Applications Group Project - VAST Challenge 2021"
...
# Welcome to Group 4's Visual Analytics Group Project Website!
...
We kick-started our group project on VAST Challenge 2021 with a **[Project Proposal](ProjectProposal.html)** to outline our approach and plan. Our **[Practice Research Paper](PracticeResearchPaper.html)** outlines the motivation behind the application created, the review of past work, design framework, use cases, discussions on new insights and future work. The **[Shiny Application](ShinyApp.html)** contains the interactive visualizations for users to access and visualize any patterns, behaviors or anomalies with a detailed **[User Guide](UserGuide.html)** prepared to help get the end users started on using the Shiny application. To get a brief context on our project and application, you may refer to our **[Project Poster](ProjectPoster.html)**.